...
interface ITranPerfHub {
  ...
  void registerEventListener(vendor.transsion.hardware.perfhub.IEventListener listener);
  void unregisterEventListener(vendor.transsion.hardware.perfhub.IEventListener listener);
}
