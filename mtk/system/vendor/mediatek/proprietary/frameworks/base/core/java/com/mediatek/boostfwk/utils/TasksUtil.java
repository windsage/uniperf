...
public final class TasksUtil {
    ...
    public static final String[] BLINK_WEBVIEW_PROCESS = {"gpu_process", "leged_process_",
    ...
    public static final String WEBVIEW_TASKS = "Chrome_InProcGp,Chrome_IOThread,hippy.js,CrGpuMain,"
        + "AcquireImageThr";
