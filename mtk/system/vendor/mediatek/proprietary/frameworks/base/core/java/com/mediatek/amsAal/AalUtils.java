...
import org.xmlpull.v1.XmlPullParserException;
 //SR: modify aal by qian.mu 20251107 start
import com.mediatek.pq.PictureQuality;
import android.os.Handler;
import android.os.Looper;
 //SR: modify aal by qian.mu 20251107 end
...
public final class AalUtils {
    ...
    // SR: add AAL ESS Custom by qian.mu 20251021 start
    private static String sAalConfigXMLProjectPath = "/odm/etc/ams_aal_config.xml";
    // SR: add AAL ESS Custom by qian.mu 20251021 end
    ...
    synchronized public void setSmartBacklightInternal(ComponentName name, int mode) {
        ...
        if (mCurrentConfig.mLevel != validLevel) {
            ...
            //SR: modify aal by qian.mu 20251107 start
            handler.post(() -> {
                 PictureQuality.setSmartBacklightStrength(validLevel);
            });
            //SR: modify aal by qian.mu 20251107 end
        }
    }
    ...
    synchronized public void setDefaultSmartBacklightInternal(String reason) {
        ...
        if (mCurrentConfig != null && mCurrentConfig.mLevel != AAL_DEFAULT_LEVEL) {
            ...
            //SR: modify aal by qian.mu 20251107 start
            PictureQuality.setSmartBacklightStrength(AAL_DEFAULT_LEVEL);
            //SR: modify aal by qian.mu 20251107 end
        }
    }
