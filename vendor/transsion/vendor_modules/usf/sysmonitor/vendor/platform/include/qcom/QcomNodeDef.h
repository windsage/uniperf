...
static constexpr const char *QCOM_GPU_UTIL_CANDIDATES[] = {
    ...
    "/sys/kernel/gpu/gpu_busy", nullptr};
...
static constexpr const char *QCOM_CPU_TEMP_PRIME_ZONE_CANDIDATES[] = {
    ...
    "cpu7",                  // SM8250 gold+
    "cpu-cluster2", nullptr};

// ---------------------------------------------------------------------------
// GPU Temperature
// ---------------------------------------------------------------------------
static constexpr const char *QCOM_GPU_TEMP_ZONE_CANDIDATES[] = {"gpuss-0-usr",    // SM8650+
                                                                "gpuss-0",        // SM8550
...
static constexpr const char *QCOM_BATTERY_TEMP_CANDIDATES[] = {
    "/sys/class/power_supply/battery/temp", "/sys/class/power_supply/Battery/temp", nullptr};
...
static constexpr const char *QCOM_CHARGER_ONLINE_CANDIDATES[] = {
    "/sys/class/power_supply/usb/online", "/sys/class/power_supply/USB/online",
