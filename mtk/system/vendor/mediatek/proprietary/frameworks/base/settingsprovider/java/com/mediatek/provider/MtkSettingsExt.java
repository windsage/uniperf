...
public final class MtkSettingsExt {
    ...
    public static final class System {
        ...
        /**
         ...
         /**
          * M: Voice wake up command status internal MTK
      ...
      /**
          * M: Voice wake up UI Disable button
          * 0: Voice wake up Disabled
          * 1: Voice wake up not complete
          * 2: Voice wake up Enabled
          *
          * @hide
          */
        ...
        /**
         * M: Voice wake up command status toggle to update observer.
         * bitmask map to command id i.e. 0 and 1
         *
         * @hide
         */
        public static final String VOICE_WAKEUP_MANAGER_COMMAND_STATUS_UPDATE =
                                                    "voice_wakeup_manager_command_status_update";

        /**
         * Voice training retrain callback status while OTA occurred.
         * -1: retrain failure
         *  0: no need to retrain keyword
         *  1: retrain success
         * @hide
         */
        public static final String VOICE_TRAINING_RETRAIN_CALLBACK_STATUS =
                                                     "voice_training_retrain_callback_status";
        /**
         * Sound recording error status to stop recording if resource busy or died.
         * update status by toggle values 0 to 1, or 1 to 0,
         * @hide
         */
        ...
        /**
         * Controls Whether the setting vloume bar or systemUi volume bar
         * @bms
         */
        public static final String BMS_FEATURE_ENABLE = "bms_feature_enable_ui";
        ...
        public static void putInPublicSettings(Set<String> PUBLIC_SETTINGS) {
            ...
            PUBLIC_SETTINGS.add(BMS_FEATURE_ENABLE);
        }
    ...
    public static final class Global {
        ...
        /**
         * Indicate dsda feature flag
         * (0 = disable, 1 = enable)
         */
        public static final String DSDA_ENABLED = "dsda_enabled";

        /** Indicate smart rat switch on or off
         * (0 = disable, 1 = enable)
         */
        public static final String SMART_RAT_SWITCH_ENABLED = "smart_rat_switch_enabled";

        /**
         * Indicate debug flag of smart rat switch
         * (0 = disable, 1 = enable)
         */
        public static final String SMART_RAT_SWITCH_DEBUG = "smart_rat_switch_debug";

        /**
         * Whether to show amplifier overheat warning notification
         * @hide
         */
        public static final String SHOW_AMPLIFIER_OVERHEAT_WARNING =
                "show_amplifier_overheat_warning";
         ...
         * @hide
         */
        public static final String TOUCH_SLOP_LEVEL =
                "touch_slop_level";
         ...
         * @hide
         */
        public static final String TOUCH_SLOP_DATA =
                "touch_slop_data";
    }
}
