...
Platform PlatformDetector::detect() {
    ...
    if (strstr(platform, "qcom") != nullptr || 
        strstr(platform, "msm") != nullptr ||
        strstr(platform, "sm") != nullptr ||
        strstr(platform, "sdm") != nullptr ||
        strstr(platform, "kona") != nullptr ||
        strstr(platform, "lahaina") != nullptr ||
        strstr(platform, "taro") != nullptr ||
        strstr(platform, "kalama") != nullptr ||
        strstr(platform, "volcano") != nullptr ||
        strstr(platform, "pineapple") != nullptr ||
    ...
    if (strstr(platform, "unisoc") != nullptr || 
...
const char* PlatformDetector::getPlatformName(Platform platform) {
    switch (platform) {
        case Platform::QCOM:   return "QCOM";
        case Platform::MTK:    return "MTK";
        case Platform::UNISOC: return "UNISOC";
