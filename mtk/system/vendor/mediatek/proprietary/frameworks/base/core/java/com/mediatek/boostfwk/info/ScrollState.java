...
import com.mediatek.boostfwk.info.ScrollMbrainSync.T3Data;
...
public final class ScrollState {
    ...
    public static boolean mListenOnDispaly = false;
    // thinking refresh rate 59 as 60HZ
    ...
    private static void notifyRefreshRateChangedIfNeeded() {
