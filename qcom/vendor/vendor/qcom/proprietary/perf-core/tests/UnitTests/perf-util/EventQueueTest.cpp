...
int32_t EventQueueTests(TestData_t &data) {
...
int8_t EventQueueTest::MultiThreadedTest(uint8_t numthreads) {
    int8_t rc;
    uint8_t i;
...
int8_t EventQueueTest::StressTest() {
    int8_t ret = 0;
...
int8_t EventQueueTest::OverNightStressTest() {
    int8_t ret = 0;
...
static RegressionFramework ttf1 = {
    "EventQueueTests_TESTS_SIMPLE", EventQueueTests, PERF_UTIL,
};

static RegressionFramework ttf2= {
    "EventQueueTests_TESTS_MULTITHREADED", EventQueueTests, PERF_UTIL,
};

static RegressionFramework ttf3 = {
    "EventQueueTests_TESTS_STRESS", EventQueueTests, PERF_UTIL,
};

static RegressionFramework ttf4 = {
    "EventQueueTests_TESTS_NIGHT_STRESS", EventQueueTests, PERF_UTIL,
};
