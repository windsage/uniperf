...
public class BaseFramePolicy implements ActivityChangeListener,
        HWUIPolicyManager.HWUIPolicyStateListener {
    ...
    HWUIPolicyStateListener mPolicyStateListener = null;
    ...
    protected void initialPolicy(Context c) {
        //only once
