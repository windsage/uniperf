#ifndef VENDOR_TRANSSION_PERFENGINE_PARAM_MAPPER_H
#define VENDOR_TRANSSION_PERFENGINE_PARAM_MAPPER_H
...
#ifndef PERFENGINE_USE_HARDCODED_MAPPINGS
#define PERFENGINE_USE_HARDCODED_MAPPINGS 0    // 开发期默认为0
#endif
...
private:
     ...
     *
     * Priority: /data/vendor/perfengine/ > /vendor/etc/perfengine/
     *
...
#endif    // VENDOR_TRANSSION_PERFENGINE_PARAM_MAPPER_H
