...
static constexpr uint32_t kMetricSlotCount = static_cast<uint32_t>(MetricId::METRIC_ID_MAX) + 1u;
...
inline const char *metricName(MetricId id) {
    switch (id) {
        case MetricId::CPU_UTIL_CLUSTER0:
            return "CPU_UTIL_CLUSTER0";
        case MetricId::CPU_UTIL_CLUSTER1:
            return "CPU_UTIL_CLUSTER1";
        case MetricId::CPU_UTIL_CLUSTER2:
            return "CPU_UTIL_CLUSTER2";
        case MetricId::CPU_UTIL_TOTAL:
            return "CPU_UTIL_TOTAL";
        case MetricId::CPU_TEMP_CLUSTER0:
            return "CPU_TEMP_CLUSTER0";
        case MetricId::CPU_TEMP_CLUSTER1:
            return "CPU_TEMP_CLUSTER1";
        case MetricId::CPU_TEMP_PRIME:
            return "CPU_TEMP_PRIME";
        case MetricId::GPU_UTIL:
            return "GPU_UTIL";
        case MetricId::GPU_TEMP:
            return "GPU_TEMP";
        case MetricId::GPU_FREQ_CUR:
            return "GPU_FREQ_CUR";
        case MetricId::SKIN_TEMP:
            return "SKIN_TEMP";
        case MetricId::SOC_TEMP:
            return "SOC_TEMP";
        case MetricId::MEM_FREE:
            return "MEM_FREE";
        case MetricId::MEM_AVAILABLE:
            return "MEM_AVAILABLE";
        case MetricId::MEM_CACHED:
            return "MEM_CACHED";
        case MetricId::MEM_SWAP_USED:
            return "MEM_SWAP_USED";
        case MetricId::MEM_PRESSURE:
            return "MEM_PRESSURE";
        case MetricId::IO_PRESSURE:
            return "IO_PRESSURE";
        case MetricId::BATTERY_CURRENT:
            return "BATTERY_CURRENT";
        case MetricId::BATTERY_TEMP:
            return "BATTERY_TEMP";
        case MetricId::BATTERY_LEVEL:
            return "BATTERY_LEVEL";
        case MetricId::CHARGER_ONLINE:
