...
static jint
com_qualcomm_qti_performance_native_perf_hint_rel(JNIEnv *env, jobject clazz, jint handle)
{
    int ret = 0;
    perf_hint_rel(handle);
    ret = 1;
...
static JNINativeMethod gMethods[] = {
    ...
    {"native_perf_hint_rel",  "(I)I",                  (int *)com_qualcomm_qti_performance_native_perf_hint_rel},
