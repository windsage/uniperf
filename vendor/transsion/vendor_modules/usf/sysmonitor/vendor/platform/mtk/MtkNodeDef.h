...
static constexpr const char *MTK_GPU_UTIL_CANDIDATES[] = {
    ...
    "/sys/devices/platform/mali.0/devfreq/mali.0/cur_load", nullptr};
...
static constexpr const char *MTK_GPU_FREQ_CANDIDATES[] = {
    ...
    "/sys/kernel/ged/hal/current_frequency", "/sys/devices/platform/mali.0/devfreq/mali.0/cur_freq",
    nullptr};
...
static constexpr const char *MTK_CPU_TEMP_PRIME_ZONE_CANDIDATES[] = {
    ...
    "mtktsprime", "cpu-prime-thermal", nullptr};
...
static constexpr const char *MTK_GPU_TEMP_ZONE_CANDIDATES[] = {
    ...
    "mtk_gpufreq_tz", "gpu-thermal", nullptr};
...
static constexpr const char *MTK_BATTERY_CURRENT_CANDIDATES[] = {
    "/sys/class/power_supply/battery/current_now", "/sys/class/power_supply/mtk-gauge/current_now",
    nullptr};

static constexpr const char *MTK_BATTERY_TEMP_CANDIDATES[] = {
    "/sys/class/power_supply/battery/temp", "/sys/class/power_supply/mtk-gauge/temp", nullptr};

static constexpr const char *MTK_BATTERY_LEVEL_CANDIDATES[] = {
    "/sys/class/power_supply/battery/capacity", "/sys/class/power_supply/mtk-gauge/capacity",
    nullptr};

static constexpr const char *MTK_CHARGER_ONLINE_CANDIDATES[] = {
    "/sys/class/power_supply/usb/online", "/sys/class/power_supply/mtk_charger/online",
