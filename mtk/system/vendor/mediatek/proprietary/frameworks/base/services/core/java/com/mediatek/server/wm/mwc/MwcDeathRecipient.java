...
/**
 * Client binder dead callback.
 */
class MwcDeathRecipient implements IBinder.DeathRecipient {
    ...
    public MwcDeathRecipient(WindowInfo windowInfo, MwcAppList mwcAppList) {
        ...
        mMwcAppList = mwcAppList;
    }

    @Override
    public void binderDied() {
        mMwcAppList.windowBinderDead(this);
    }
