...
interface ISysMonitor {
  ...
  void registerListener(in vendor.transsion.hardware.sysmonitor.IMetricListener listener, in int[] metricIds, in long[] thresholds);
  void unregisterListener(in vendor.transsion.hardware.sysmonitor.IMetricListener listener);
