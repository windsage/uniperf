...
public class PictureQuality {
    ...
    public static boolean setTranPictureMode(int mode,String packageName,int sha,int sat,int con,int bri,int step){
        boolean result = nativeSetTranPictureMode(mode,sha,sat,con,bri,step);
        Log.d("PictureQuality::setTranPictureMode", "nativeSetTranPictureMode result " + result);
        return result;
    }
    ...
    //SPD: add for LCQHLYYLR-65 by feng.an 20220410 end

    //SDD:add for NFRFP-28747 by xiangbo.li 20241226 start
    public static void setFunction(int funcFlags, boolean propFlag) {
        nativeSetFunction(funcFlags, propFlag);
    }

    public static void setDisplayGamePQ(int featureFlag, int selTable, int featureParam2) {
        nativeSetDisplayGamePQ(featureFlag, selTable, featureParam2);
    }

    public static void setDisplayGamePQV2MPq(int pqId, int pqIdFlag, int featureFlag, int colorSelTable, int dreSelTable, int colorStep, int dreStep) {
        nativeSetDisplayGamePQV2MPq(pqId, pqIdFlag, featureFlag, colorSelTable, dreSelTable, colorStep, dreStep);
    }
...
//BSP: add for c3d ADJHBSY-4107 by meng.zhang 20220718 start
     ...
     * Enable C3D.
     */
    public static boolean enableC3D(boolean enable) {
        return nativeEnableC3D(enable);
    }

    /**
     * Check whether C3D is enabled.
     */
    public static boolean isC3DEnabled() {
        return nativeIsC3DEnabled();
    }
...
//TR: add for c3d ADJHBSY-4107 by xiaosong.wang 20220825 start
     ...
     * Check whether C3D is enabled.
     */
    public static boolean deleteC3DCaliFile() {
        return nativeDeleteC3DCaliFile();
    }

    /**
     * Check whether C3D is enabled.
     */
    public static int getC3dCaliFileSize() {
        return nativeGetC3dCaliFileSize();
    }

    /**
     * Get C3D calibration status.
     */
    public static int getC3dCaliStatus() {
        return nativeGetC3dCaliStatus();
    }

    /**
     * Send c3d calibration pass command to bind lcd code.
     */
    public static boolean c3dCaliPass(int lcdIndex) {
        return nativeC3dCaliPass(lcdIndex);
    }
//TR: add for c3d ADJHBSY-4107 by xiaosong.wang 20220825 end

//TR:add display ccm XLBSSB-2302 by xiaosongwang 20230202 start
    /**
     * Check ccorr Calibration Status
     */
    public static int getCcorrCaliStatus() {
        return nativeGetCcorrCaliStatus();
    }
    /**
     * load ccorr cali file.
     */
    public static boolean loadCcorrCaliData() {
        return nativeLoadCcorrCaliData();
    }

    /**
     * use default ccorr value.
     */
    public static boolean useCcorrDefault() {
        return nativeUseCcorrDefault();
    }

    /**
     * backup ccorr cali file.
     */
    public static boolean backupCcorrCali() {
        return nativeBackupCcorrCali();
    }

    /**
     * delete ccorr cali file.
     */
    public static boolean deleteCcorrCaliFile() {
        return nativeDeleteCcorrCaliFile();
    }

    /**
     * Check screen status is ok or not.
     */
    public static boolean getScreenStatus() {
        return nativeGetScreenStatus();
    }

    /**
     * ensure ccorr calibration is ok.
     */
    public static boolean ccorrCaliPass() {
        return nativeCcorrCaliPass();
    }

    /**
     * get Lcd index from lcm list
     */
    public static int getLcdIndex() {
        return nativeGetLcdIndex();
    }
//TR:add display ccm XLBSSB-2302 by xiaosongwang 20230202 end
    ...
    *
    * @param isEnable: 0/1
    * @param rangeLimit: 0~255
    * @param baseValue: 0~255
    * @param colorARange: 0~255
    * @return enable status
    */
    public static boolean enablePaperMode(int isEnable, int rangeLimit, int baseValue,
                                                   int colorARange)
     {
         return nativeEnablePaperMode(isEnable, rangeLimit, baseValue, colorARange);
     }

    /**
    * get whether paper-like is enabled.
    *
    * @return paper enable status
    */
    public static boolean isPaperModeEnabled() {
        return nativeIsPaperModeEnabled();
    }
    ...
    /**
     * Get Tuning Field Value
     * @param pqModule PQ Module ID
     * @param field    Tuning Field Offset
     * @return Tuning Field Value
     */
    public static int getTuningField(int pqModule, int field) {
        Log.d("PictureQuality::GetTuningField", "pqModule: " + pqModule + ", field: " + field);
        return nativeGetTuningField(pqModule, field);
    }

    /**
     * Set Tuning Field Value
     * @param pqModule PQ Module ID
     * @param field    Tuning Field Offset
     * @param value    Tuning Field Value
     * @return True: Success, False: Failure
     */
    public static boolean setTuningField(int pqModule, int field, int value) {
        Log.d("PictureQuality::SetTuningField", "pqModule: " + pqModule
                                                + ", field: " + field
                                                + ", value: " + value);
        return nativeSetTuningField(pqModule, field, value);
    }
    ...
    //SPD: add for PQE LCQHLYYLR-65 by feng.an 20220410 start
    private static native boolean nativeSetTranPictureMode(int mode,int sha,int sat,int con,int bri, int step);
    private static native void nativeSetPQLogEnable(boolean enable);
    //SPD: add for PQE LCQHLYYLR-65 by feng.an 20220410 end
    //SDD:add for NFRFP-28747 by xiangbo.li 20241226 start
    private static native void nativeSetFunction(int funcFlags, boolean propFlag);
    private static native void nativeSetDisplayGamePQ(int featureFlag, int selTable, int featureParam2);
    private static native void nativeSetDisplayGamePQV2MPq(int pqId, int pqIdFlag, int featureFlag, int colorSelTable, int dreSelTable, int colorStep, int dreStep);
    //SDD:add for NFRFP-28747 by xiangbo.li 20241226 end
...
//BSP: add for c3d ADJHBSY-4107 by meng.zhang 20220718 start
    private static native boolean nativeEnableC3D(boolean isEnable);
    private static native boolean nativeIsC3DEnabled();
//BSP: add for c3d ADJHBSY-4107 by meng.zhang 20220718 end
//TR: add for c3d ADJHBSY-4107 by xiaosong.wang 20220825 start
    private static native boolean nativeDeleteC3DCaliFile( );
    private static native int nativeGetC3dCaliFileSize( );
    private static native int nativeGetC3dCaliStatus( );
    private static native boolean nativeC3dCaliPass(int lcdIndex);
//TR: add for c3d ADJHBSY-4107 by xiaosong.wang 20220825 end
//TR:add display ccm XLBSSB-2302 by xiaosongwang 20230202 start
    private static native int nativeGetCcorrCaliStatus( );
    private static native boolean nativeLoadCcorrCaliData( );
    private static native boolean nativeUseCcorrDefault( );
    private static native boolean nativeBackupCcorrCali( );
    private static native boolean nativeDeleteCcorrCaliFile( );
    private static native boolean nativeGetScreenStatus( );
    private static native boolean nativeCcorrCaliPass( );
    private static native int nativeGetLcdIndex( );
//TR:add display ccm XLBSSB-2302 by xiaosongwang 20230202 end
    ...
    private static native void nativeSetESS20Enable(boolean isEnable, int ELVSSPNIndex, boolean choice);
    private static native int nativeGetTuningField(int pqModule, int field);
    private static native boolean nativeSetTuningField(int pqModule, int field, int value);
    private static native boolean nativeEnablePaperMode(int isEnable, int rangeLimit,
                                           int baseValue, int colorARange);
    private static native boolean nativeIsPaperModeEnabled();
}
