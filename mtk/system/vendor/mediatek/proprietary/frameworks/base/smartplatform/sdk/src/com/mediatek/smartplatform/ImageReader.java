...
//        }
    ...
    public FileDescriptor enableShareBuffer(boolean enable, int size, int yuvType, int numPlanes) {
        return nativeEnableShareBuffer(enable, size, yuvType, numPlanes);
    }

    public void makeCallbackAndSharebufferCoexist(boolean enable) {
        nativeMakeCallbackAndSharebufferCoexist(enable);
    }
    ...
    private class SurfaceImage extends com.mediatek.smartplatform.Image {
        ...
        public ByteBuffer getByteBuffer() {
            throwISEIfImageIsInvalid();
            if(mByteBuffer == null) {
                mByteBuffer = nativeGetByteBuffer(ImageReader.this.mNumPlanes, ImageReader.this.mFormat);
            }
            return mByteBuffer;
        }
        ...
        private class SurfacePlane extends com.mediatek.smartplatform.Image.Plane {
        ...
        /**
        * This field is used to keep track of ImageReader object and used by native code only.
        * Don't modify.
        */
        private long mNativeImageReader;
        ...
        private synchronized native ByteBuffer nativeGetByteBuffer(int numPlanes,
                int readerFormat);
    }
    ...
    private synchronized native FileDescriptor nativeEnableShareBuffer(boolean enable,
                                                                int size, int yuvType, int numPlanes);
    private synchronized native void nativeMakeCallbackAndSharebufferCoexist(boolean enable);
