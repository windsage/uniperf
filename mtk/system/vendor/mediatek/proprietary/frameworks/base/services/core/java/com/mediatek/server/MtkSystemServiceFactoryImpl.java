...
public class MtkSystemServiceFactoryImpl extends MtkSystemServiceFactory {
    ...
    // OS:add for reinstall by fuyin.liu 20250509 start
    private PmsExt mPmsExt = new PmsExtImpl();
    // OS:add for reinstall by fuyin.liu 20250509 end
