...
public class MtkLocationExt {
    ...
    public static class GnssLocationProvider {
        ...
        public GnssLocationProvider(Context context, Handler handler) {
            Log.d(TAG, "GnssLocationProvider()");
            mContext = context;
            mHandler = handler;
            ...
            mContext.registerReceiverAsUser(new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if (Intent.ACTION_BOOT_COMPLETED.equals(action)) {
                        ...
                        Log.d(TAG, "BOOT_COMPLETED, GPS Time sync is " + gpsTimeSyncStatus);
                        setGpsTimeSyncFlag(gpsTimeSyncStatus);
                        mGpsHandler.obtainMessage(EVENT_SEND_BLUESKY_BROADCAST).sendToTarget();
                    }
                }
        ...
        private class MyHandler extends Handler {
            ...
            public void handleMessage(Message msg) {
                ...
                case EVENT_GPS_TIME_SYNC_CHANGED:
                    ...
                    break;
                case EVENT_SEND_BLUESKY_BROADCAST:
                    BlueskyUtility.sendBlueskyBroadcast(mContext);
                    //Log.d(TAG, "Finish Bluesky broadcast");
                    break;
                }
            }
        }
        ...
        public void onGpsTimeChanged(boolean enable) {
            if (enable) {
                startUsingGpsWithTimeout(180000, mContext.getString(
                        com.mediatek.internal.R.string.gps_time_sync_fail_str));
            } else {
